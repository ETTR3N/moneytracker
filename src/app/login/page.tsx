  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-950 px-4">
      ...
      <motion.form
        ...
        action={formAction}
        className="relative w-full max-w-sm rounded-3xl border border-neutral-800 bg-neutral-900/80 p-8 shadow-2xl backdrop-blur"
      >
        ...
        <h1 className="mb-1 text-2xl font-bold tracking-tight text-neutral-50">
          Money Tracker
        </h1>
